...
import { run } from "./run.dev.prebuilt-candidate-build-static-probe.js";

describe("dev-only pre-built candidate-build + static hosted probe", () => {
  it("executes complete candidate construction without changing the proven static expand", () => {
    const result = run({
      cart: {
        lines: [{
